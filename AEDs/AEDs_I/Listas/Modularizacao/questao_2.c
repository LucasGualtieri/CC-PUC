...
// Essa função recebe um número inteiro n e mostra na tela (em ordem decrescente) ->
// todos os valores menores do que par(n) para a sequência { 2, 4, 6, 8, 10, 12... }
void MostrarParOrdemDecre(int n) {
	printf("\n{");
	for (int i = par(n) - 2; i >= 0; i -= 2) {
