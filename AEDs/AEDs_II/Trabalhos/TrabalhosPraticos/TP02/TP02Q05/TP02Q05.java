...
// clear && javac TP02Q05.java && java TP02Q05 < pub.in > result.txt

class TP02Q05 {

	static int strcmpr(Jogador jog1, Jogador jog2) {
		return jog1.getNome().compareTo(jog2.getNome());
	}

	static void swap(int i, int menor, Jogador[] array) {
		Jogador aux = array[i];
		array[i] = array[menor];
		array[menor] = aux;
	}

	static void SelectionSort(Lista lista, ResultadoPesquisa resultado) {
		...
		for (i = 0; i < lista.size - 1; i++) {
			...
			swap(i, menor, lista.array);
			resultado.incrementarMovimentacoes(3);
		}
	...
	public static void main(String[] args) throws Exception {
		...
		SelectionSort(jogadores, resultado);
		timer.Stop();
...
class ResultadoPesquisa {
	...
	public void incrementarMovimentacoes(int movimentacoes) { this.movimentacoes += movimentacoes; }
}
