...
// clear && javac TP02Q03.java && java TP02Q03 < pub.in > result.txt

class TP02Q03 {

	static void PesquisaSequencial(String nome, Lista lista, ResultadoPesquisa resultado) {
	...
	public static void main(String[] args) throws Exception {
		...
		Lista jogadores = new Lista(74); // Tamanho de entradas do pri.in
		...
		registroLog(timer, resultado.getComparacoes());		
