package AEDs.AEDs_II.Trabalhos.TrabalhosPraticos.TP04.TP04Q08;
...
// clear && javac -cp ../.. TP04Q08Verde.java && java -cp ../.. TP04Q08Verde.java < pub.in > result.txt
...
class TP04Q08Verde {
	...
	static class ReHash {
		...
		public ReHash(int tabelaLen) {
			...
			this.array = new Lib.Jogador[tabelaLen];
		...
		private int rehash(Lib.Jogador jogador) {
		...
		boolean CompareToNome(Lib.Jogador jog1, Lib.Jogador jog2, Lib.Log log) {
			log.incrementarComparacoes();
